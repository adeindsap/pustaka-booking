                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="<?= base_url('buku/ubahkategori/').$k['id'];?>" class="badge badge-dark"><i class="fas fa-edit"></i> Ubah</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('buku/kategori'); ?>" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-dark" data-dismiss="modal"><i class="fas fa-ban"></i>Close</button>
